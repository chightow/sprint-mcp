...
import (
	...
	"github.com/chightow/sprint-mcp/internal/commands"
	"github.com/chightow/sprint-mcp/internal/project_context"
	"github.com/chightow/sprint-mcp/internal/sprint"
)
...
func main() {
	...
	s := server.NewMCPServer("sprint-mcp", "1.0.0",
